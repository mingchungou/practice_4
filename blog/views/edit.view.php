                ...
                <article class="container">
                    ...
                    <form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group row <?php echo empty($errors["title"]) ? "" : "has-danger"; ?>">
                            ...
                            <div class="col-md-10">
                                <input type="text" class="form-control form-control-danger" id="title" name="title" placeholder="Ingrese un título" value="<?php echo isset($blog) ? $blog["title"] : $title; ?>" />
                            </div>
                        ...
                        <div class="form-group row <?php echo empty($errors["extract"]) ? "" : "has-danger"; ?>">
                            ...
                            <div class="col-md-10">
                                <input type="text" class="form-control form-control-danger" id="extract" name="extract" placeholder="Ingrese un extracto" value="<?php echo isset($blog) ? $blog["extract"] : $extract; ?>" />
                            </div>
                        ...
                        <div class="form-group row <?php echo empty($errors["text"]) ? "" : "has-danger"; ?>">
                            ...
                            <div class="col-md-10">
                                <textarea class="form-control form-control-danger" id="text" name="text" placeholder="Ingrese el texto"><?php echo isset($blog) ? $blog["text"] : $text; ?></textarea>
                            </div>
                        ...
                        <input type="hidden" name="thumb-stored" value="<?php echo isset($blog) ? $blog["thumb"] : $thumbStored; ?>" />
